...
PAINT_THEMES = {
    ...
    "wormhole_monsoon": {
        "name": "季风暴雨·雷雨滂沱",
        "desc": "暴雨如瀑倾泻，闪电劈裂云层，水幕倒挂天穹，雨滴折射霓虹",
        "neon_color": (80, 120, 180),
        "accent_color": (150, 200, 255),
    ...
    "wormhole_mirage": {
        "name": "沙漠海市·幻影绿洲",
        "desc": "蜃景宫殿浮现，光线扭曲折射，虚幻湖泊倒影，不存在的绿洲",
        "neon_color": (255, 220, 150),
        "accent_color": (100, 200, 255),
    ...
    "wormhole_bonsai": {
        "name": "盆景园·微缩天地",
        "desc": "微型山水盆景，禅意枯山水，小桥流水人家，袖珍世界浓缩",
        "neon_color": (100, 150, 80),
        "accent_color": (180, 200, 120),
        "trail_color": (120, 160, 100),
        "unlocked": False,
        "cost": 2400,
        "trail_style": "leaf",
        "particle_count": 95,
    ...
    "wormhole_lantern": {
        "name": "灯笼祭·万灯漂浮",
        "desc": "天灯缓缓升空，灯笼节盛况，纸灯漂浮如星，祈愿之光飘荡",
        "neon_color": (255, 180, 80),
        "accent_color": (255, 220, 150),
        "trail_color": (255, 200, 100),
        "unlocked": False,
        "cost": 2600,
    ...
    "wormhole_geode": {
        "name": "晶洞秘境·宝石溶洞",
        "desc": "紫晶洞内壁闪耀，多彩晶簇生长，矿石反光折射，地质奇观绚丽",
        "neon_color": (150, 100, 200),
        "accent_color": (200, 150, 255),
        "trail_color": (180, 120, 220),
        "unlocked": False,
        "cost": 2800,
        "trail_style": "crystal",
        "particle_count": 110,
    ...
    "wormhole_totem": {
        "name": "图腾柱·部落图腾",
        "desc": "远古图腾柱矗立，部落面具堆叠，神秘符文发光，祖灵守护显现",
        "neon_color": (200, 100, 50),
        "accent_color": (255, 150, 80),
        "trail_color": (180, 120, 60),
        "unlocked": False,
        "cost": 3000,
        "trail_style": "tribal",
        "particle_count": 105,
    ...
    "wormhole_ruins": {
        "name": "废墟遗迹·古代文明",
        "desc": "断壁残垣浮现，古文明符号，神殿石柱漂浮，失落帝国回响",
        "neon_color": (180, 160, 120),
        "accent_color": (220, 200, 150),
        "trail_color": (160, 140, 100),
        "unlocked": False,
        "cost": 3200,
        "trail_style": "stone",
        "particle_count": 120,
    ...
    "wormhole_teaceremony": {
        "name": "茶道静寂·一期一会",
        "desc": "茶室氛围沉静，茶叶漂浮旋转，蒸汽袅袅升起，禅茶一味意境",
        "neon_color": (150, 180, 120),
        "accent_color": (200, 220, 160),
        "trail_color": (180, 200, 140),
        "unlocked": False,
        "cost": 3400,
        "trail_style": "mist",
        "particle_count": 115,
    ...
    "wormhole_windchime": {
        "name": "风铃物语·清音叮当",
        "desc": "风铃随风摇曳，音波可视涟漪，清脆声浪扩散，玻璃铃铛碰撞",
    ...
    "wormhole_silk_road": {
        "name": "丝绸之路·商队旅途",
        "desc": "驼铃悠扬响起，丝绸飘带飞舞，贸易路线发光，东西文明交融",
        "neon_color": (255, 200, 150),
        "accent_color": (200, 150, 100),
        "trail_color": (220, 180, 130),
        "unlocked": False,
        "cost": 3800,
        "trail_style": "silk",
        "particle_count": 125,
    ...
    "wormhole_supercell": {
        "name": "超级单体·龙卷母体",
        "desc": "超级雷暴云团，墙云旋转下降，多重涡旋嵌套，龙卷风酝酿中",
        "neon_color": (80, 100, 120),
    ...
    "wormhole_paperlamp": {
        "name": "纸灯长廊·和式灯影",
        "desc": "纸质灯笼排列，光影柔和漫射，日式走廊氛围，温暖灯光笼罩",
...
BULLET_THEMES = {
    ...
    "wormhole_rift_shard": {
        "name": "裂隙碎片",
        "desc": "时空裂缝的碎片，扭曲周围空间，拖曳维度残影",
        "cost": 2800,
        "color": (180, 100, 255),
        "trail_color": (150, 80, 220),
        "shape": "rift_shard",
        "size_mult": 1.4,
        "effects": ["dimensional_tear", "space_distortion"],
        "category": "exclusive",
        "exclusive_plane": "wormhole",
    },
    "wormhole_void_spike": {
        "name": "虚空尖刺",
        "desc": "虚空能量凝聚的锋锐尖刺，穿透现实，撕裂空间",
        "cost": 3000,
        "color": (120, 0, 180),
        "trail_color": (100, 0, 150),
        "shape": "void_spike",
        "size_mult": 1.6,
        "effects": ["void_pierce", "reality_tear"],
        "category": "exclusive",
        "exclusive_plane": "wormhole",
    },
    "wormhole_singularity": {
        "name": "奇点核心",
        "desc": "微型黑洞奇点，吞噬光线，扭曲时空，引力波纹",
        "cost": 3200,
        "color": (80, 40, 120),
        "trail_color": (60, 30, 100),
        "shape": "singularity",
        "size_mult": 1.8,
        "effects": ["gravity_well", "light_absorption"],
        "category": "exclusive",
        "exclusive_plane": "wormhole",
    },
    "wormhole_plasma_vortex": {
        "name": "等离子漩涡",
        "desc": "高能等离子漩涡，螺旋运动，电弧四溅，能量风暴",
        "cost": 3400,
        "color": (100, 220, 255),
        "trail_color": (80, 200, 240),
        "shape": "plasma_vortex",
        "size_mult": 1.5,
        "effects": ["plasma_spiral", "electric_discharge"],
        "category": "exclusive",
        "exclusive_plane": "wormhole",
    },
    "wormhole_chrono_bolt": {
        "name": "时序箭矢",
        "desc": "时间能量箭矢，拖曳时钟残影，留下时间裂痕",
        "cost": 3600,
        "color": (255, 200, 100),
        "trail_color": (230, 180, 80),
        "shape": "chrono_bolt",
        "size_mult": 1.7,
        "effects": ["time_trail", "temporal_fracture"],
        "category": "exclusive",
        "exclusive_plane": "wormhole",
    },
    "wormhole_nebula_burst": {
        "name": "星云爆发",
        "desc": "压缩星云能量，彩色云雾爆裂，星尘飞散",
        "cost": 3800,
        "color": (255, 150, 200),
        "trail_color": (230, 130, 180),
        "shape": "nebula_burst",
        "size_mult": 1.6,
        "effects": ["nebula_explosion", "stardust_scatter"],
        "category": "exclusive",
        "exclusive_plane": "wormhole",
    },
    "wormhole_antimatter": {
        "name": "反物质湮灭",
        "desc": "反物质粒子，正反湮灭光芒，能量对撞，闪耀爆炸",
        "cost": 4000,
        "color": (255, 255, 255),
        "trail_color": (240, 240, 255),
        "shape": "antimatter",
        "size_mult": 1.5,
        "effects": ["antimatter_glow", "annihilation_flash"],
        "category": "exclusive",
        "exclusive_plane": "wormhole",
    },
