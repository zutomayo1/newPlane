    ...
    try:
        ...
        # ========== Wormhole 混沌虫洞子弹预览 ==========
            ...
            for i in range(3):
                offset = (i - 1) * size//8
                alpha = 150 - i * 40
                pygame.draw.circle(surface, (*color, alpha), (center_x + offset, center_y), size//5)
            ...
            pygame.draw.polygon(surface, (255, 220, 150, 200), hex_points)
            pygame.draw.polygon(surface, color, hex_points, 2)
            # 连接中心线
            for i in range(6):
                pygame.draw.line(surface, (240, 200, 130, 150), (center_x, center_y), hex_points[i], 1)
            # 温暖光晕
            ...
            pygame.draw.polygon(surface, (180, 100, 240, 200), crystal_points)
            ...
            for i in range(2):
                ...
                alpha = 180 - i * 60
                pygame.draw.circle(surface, (180, 100, 240, alpha), (center_x, center_y), pulse_r)
            # 裂纹闪光
            for i in range(6):
                angle = (i * 60) * 3.14159 / 180
            ...
            for i in range(4):
                ...
                pygame.draw.line(surface, (200, 180, 150), 
                               (text_x, text_y - size//20), (text_x, text_y + size//20), 2)
                # 横线
                if i % 2 == 0:
                    pygame.draw.line(surface, (200, 180, 150), 
                                   (text_x - size//25, text_y), (text_x + size//25, text_y), 2)
            # 历史回响波纹
        ...
        # ========== Mirage (幻镜·万华) 子弹形状 ==========
        elif "refraction_split" in effects or "rainbow_trail" in effects:
            # 棱镜折射弹：三角棱镜+彩虹折射
            # 棱镜主体（三角形）
            prism_points = [
                (center_x, center_y - size//2),
            ...
            for i in range(3):
                ...
                x2 = center_x + int(size//2 * math.cos(angle))
                y2 = center_y + int(size//2 * math.sin(angle))
                pygame.draw.line(surface, (*color, 150), (center_x, center_y), (x2, y2), 1)
        ...
        # ========== Gambit (命运赌徒·艾斯) 子弹形状 ==========
        elif "card_spin" in effects or "suit_change" in effects:
            # 飞牌利刃弹：旋转扑克牌
            # 扑克牌轮廓
            ...
            # 轮盘赌球弹：轮盘+小球
            # 轮盘
            pygame.draw.circle(surface, (50, 100, 50), (center_x, center_y), size//2.5)
            pygame.draw.circle(surface, (200, 150, 50), (center_x, center_y), size//2.5, 3)
            # 红黑格子
            for i in range(12):
                angle = i * 30 * 3.14159 / 180
            ...
            # 小丑帽尖
            hat_points = [(center_x, center_y - size//2.5), 
                         (center_x - size//6, center_y - size//4),
                         (center_x + size//6, center_y - size//4)]
